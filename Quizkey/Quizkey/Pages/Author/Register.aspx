    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="mb-3 row">
                ...
                <input type="name" class="form-control" id="txtKorisnickoIme" placeholder="Name">
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <input type="password" class="form-control" id="txtZaporka" placeholder="password">
            </div>

            <div class="mb-3 row">
                <label for="exampleFormControlInput1" class="form-label">Ponovljena zaporka</label>
                <input type="rpassword" class="form-control" id="txtPonovljenazaporka" placeholder="password">
            </div>
            <div class="mb-3 row">
